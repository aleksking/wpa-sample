...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 06, 2015 at 04:49 AM
...
CREATE TABLE IF NOT EXISTS `registered_fees` (
  ...
  `status` int(5) NOT NULL DEFAULT '1' COMMENT '1:waiting 2:success 3:fail'
...
INSERT INTO `registered_fees` (`id`, `salutation`, `first_name`, `last_name`, `email`, `birthdate`, `contact`, `food_diet`, `pay_no`, `payment_desc`, `reg_no`, `address`, `amount`, `status`) VALUES
(0, 2, 'asdf', 'adsf', 'yongboang@hotmail.com', '12232323', '1231231', 2, 13, 'P10,000.00', '', '', '', 1),
(0, 2, 'Yongbo', 'Ang', 'yongboang@gmail.com', '12232323', '1231231', 2, 4, 'P20,250 / USD 450', '', '', '', 1),
(0, 2, 'Yongbo', 'Ang', 'yongboang@gmail.com', '12232323', '1231231', 2, 10, 'P15,750.00 / USD 350', '', '', '', 1),
(0, 1, 'Yongbo', 'Ang', 'yongboang@gmail.com', '05/25/1984', '09339463363', 2, 1, 'P26,100.00 / USD 580', 'ajlBGHL237', 'China Bank, 3rd floor', '26100.00', 1),
(0, 1, 'Yongbo', 'Ang', 'yongboang@gmail.com', '05/25/1984', '09339463363', 1, 1, 'P26,100.00 / USD 580', 'ckvwHKLU08', 'China Bank, 3rd floor', '26100.00', 1),
(0, 1, 'Yongbo', 'Ang', 'yongboang@gmail.com', '05/25/1984', '09339463363', 2, 1, 'P26,100.00 / USD 580', 'dfkstxFK29', 'China Bank, 3rd floor', '26100.00', 1),
(0, 1, 'Yongbo', 'Ang', 'yongboang@hotmail.com', '12232323', '09339463363', 3, 13, 'P10,000.00', 'bfknoqrvADFLMOTUWX37', 'China Bank, 3rd floor', '10000.00', 1);
